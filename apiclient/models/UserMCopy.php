...
//*********************************************************************************************** CRUD
        ...
        try {
            ...
            if ($create){
                ...
                if ($this->invitation){
                    ...
                    $this->status = UserM::STATUS_WAITING_FOR_EMAIL_CONFIRM;
                } else {
    ...
    public function sentInvitationConfirm($user)
    {
        try{
            $email = $user->email;
            ...
            $sent = $mailer
                ->compose(
                    ['html' => 'invitationConfirm-html.php', 'text' => 'invitationConfirm-text.php'],
                    ['user' => $user])
                ->setTo($email)
